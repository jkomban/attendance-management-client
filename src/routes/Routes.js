...
import AdmissionMgmt from '../screens/admissions';
...
const Routes = props => {
    ...
    return (
        <Switch>
            ...
            <PrivateRoute exact path="/grade" component={GradeScreen}></PrivateRoute>
            <PrivateRoute exact path="/manage/admissions" component={AdmissionMgmt}></PrivateRoute>
